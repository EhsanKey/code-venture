...
describe("CircularQueue", () => {
  ...
  test("should add elements to the queue and delete elements from the queue", () => {
    queue.add("first");
    queue.add("second");
    queue.add("third");
    queue.add("fourth");
  ...
  test("should throw an error when queue is full after adding and deleting elements", () => {
    queue.add("first");
    queue.add("second");
    queue.add("third");
    queue.add("fourth");
    ...
    queue.add("sixth");
    queue.add("seventh");
    expect(() => queue.add("eighth")).toThrow("Queue is full");
  });
  ...
  test("should print the queue correctly", () => {
    ...
    queue.add("third");
    queue.print();
    expect(console.log).toBeCalledWith("first second third");
  });
